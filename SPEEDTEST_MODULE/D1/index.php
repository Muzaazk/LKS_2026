...
$langs = isset($_POST['lang']) ? $_POST['lang'] : "ind";
$lang = $id;
$lang = $langs === "dutch" ? $nl : $id;
  ...
  <nav class="navbar">
    <div class="container">
      ...
      <ul>
        ...
        <li><a href="#"><?php echo $lang['contact_us'];
                        ?>
          </a></li>
        <li><a href="#"><?php echo $lang['register'];
                        ?>
          </a></li>
        <li><a href="#"> <?php echo $lang['login'];
                          ?>
          </a></li>
        <li class="language-form">
          <form id="langForm" action="" method="post">
            <select name="lang" id="lang" onchange="submitForm()">
              <option value="ind" <?= $_POST['lang'] == "ind" ? "selected" : "" ?>>Indonesia</option>
